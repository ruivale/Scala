error id: file:///C:/D/Projects/GIT/_GitHub/Private/ruivale/Scala/Mp3Idv2Tagging/src/main/scala/Main.scala:
file:///C:/D/Projects/GIT/_GitHub/Private/ruivale/Scala/Mp3Idv2Tagging/src/main/scala/Main.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -sttp/client3/addMp3Tags.
	 -sttp/client3/addMp3Tags#
	 -sttp/client3/addMp3Tags().
	 -ujson/addMp3Tags.
	 -ujson/addMp3Tags#
...
//    }
  ...
  //
  // For the given file, tries to extrapolate its song name and artist from the file's name.
